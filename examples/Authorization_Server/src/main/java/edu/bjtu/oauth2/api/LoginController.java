...
public class LoginController {
    @Autowired
    private JdbcClientDetailsService clientDetailsService1;
    ...
    public ModelAndView root(Map<String,Object> model, Principal principal){
        ...
        List<Approval> approvals=clientDetailsService1.listClientDetails().stream()
        ...
        model.put("clientDetails",clientDetailsService1.listClientDetails());
